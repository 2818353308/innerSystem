		...
		$(function(){
			$("#tree").tree({
				...
				onClick: function(node){
					changgeRightContent("${pageContext.request.contextPath}"+node.path)  // 在用户点击的时候提示
				},
...
<body class="easyui-layout" onclick="test111('123')">
	<div data-options="region:'north',border:false"
		...
		欢迎用户：张三登录系统 用户角色：文件管理员 当前系统时间：<tags:ShowCurrentDate /><a href="#">登出</a>
	</div>
	...
	<div data-options="region:'center',title:'业务功能区'">
		<iframe id="rightContent" width="100%" height="100%" src="${pageContext.request.contextPath}/user/toList.htmlx" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no"   />
	</div>
</body>
	<script type="text/javascript">
